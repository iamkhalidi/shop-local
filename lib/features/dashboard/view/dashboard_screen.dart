...
//             borderRadius: BorderRadius.circular(30),
//             child: BackdropFilter(
//               // ميزة الـ Blur التي تمنح المتجر تأثير الزجاج السائل الانسيابي (Liquid Glass)
//               filter: ImageFilter.blur(sigmaX: 15, sigmaY: 15),
//               child: Container(
//                 color: Colors.white.withOpacity(0.75), // طبقة زجاجية بيضاء شبه شفافة
//                 padding: const EdgeInsets.symmetric(horizontal: 10),
//                 child: Row(
//                   mainAxisAlignment: MainAxisAlignment.spaceAround,
//                   children: [
...
//   }
//
//   // ويدجت لبناء أزرار شريط التنقل بشكل متناسق ومستمع لـ GetX التفاعلي
//   Widget _buildNavItem(IconData unselectedIcon, IconData selectedIcon, String label, int index) {
//     return Obx(() {
//       final isSelected = controller.currentIndex.value == index;
//       return GestureDetector(
...
//           decoration: BoxDecoration(
//             // خلفية سائلة انسيابية بارزة للأيقونة المحددة فقط
